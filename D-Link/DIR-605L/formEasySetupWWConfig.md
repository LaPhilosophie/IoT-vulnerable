...
In the D-Link DIR-605L 2.13B01 BETA firmware has a buffer overflow vulnerability in the `formEasySetupWWConfig` function. The `Var` variable receives the `curTime` parameter from a POST request. However, since the user can control the input of `curTime`, the `sprintf` can cause a buffer overflow vulnerability.

![image-20240926125212874](https://raw.githubusercontent.com/abcdefg-png/images2/main/image-20240926125212874.png)

![image-20240926125228272](https://raw.githubusercontent.com/abcdefg-png/images2/main/image-20240926125228272.png)
...
def poc():
    target_url = "goform/formEasySetupWWConfig"
